...
import { DbConnectionOptionsInterface, DbSettings } from "../types/interfaces";
...
const generateConnectionURI = (serviceDB: DbSettings): string => {
...
const dbConnectionOptions: DbConnectionOptionsInterface = {
 ...
 */
export  function dbConnect(dbSettings: DbSettings) {
